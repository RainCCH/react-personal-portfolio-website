  ...
  return (
    <div className="about-container">
      ...
      <p className="about-text">
        ...
        I am currently seeking software development internship opportunities in Canada. Here is my <a href={resume} target="_blank" rel="noopener noreferrer" className="school-link">resume</a>. Should you find my skills and experiences align with your needs, please do not hesitate to contact me! <br />
      </p>
      </Fade>
    </div>
  );
